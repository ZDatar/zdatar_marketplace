...
class ProposalCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final againstPercentage = totalVotes > 0 ? (votesAgainst / totalVotes) * 100 : 0.0;
            ...
            if (status != 'active')
              Container(
                ...
                decoration: BoxDecoration(
                  color: _getResultColor(status).withOpacity(0.1),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      status == 'passed' ? 'Proposal Passed' : 'Proposal Rejected',
                      style: TextStyle(
                        color: _getResultColor(status),
                        fontWeight: FontWeight.w600,
                      ),
